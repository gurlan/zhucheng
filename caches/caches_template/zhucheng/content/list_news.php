    ...
    <div class="content_left">
        ...
        <div class="news distance fix">
            ...
            <ul>
                ...
                <li><a href="<?php echo $r['url'];?>"><i><img src="/template/images/news_bt1.png"/></i><span><?php echo $r['title'];?></span><p>【<?php echo date("Y-m-d",$r[inputtime]);?>】</p></a></li>
                <?php $n++;}unset($n); ?>
            </ul>
        </div>
        <!--page-->
