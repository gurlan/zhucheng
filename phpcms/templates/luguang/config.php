<?php return array (
  ...
  array (
    ...
    'templates|longchikeji|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|longchikeji|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|longchikeji|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|longchikeji|wap' => 
    array (
    ...
    'templates|longchikeji|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|longchikeji|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|longchikeji|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|longchikeji|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|longchikeji|yp' => 
    array (
      'com_longchikeji' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|longchikeji|yp|com_longchikeji' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|longchikeji|comment' => 
    array (
